...
Because of a lack of programming knowledge, i let claude code do its magic in phyton/websocket/html/css stuff to get it to work with my devies in the same look. I let claude create a config file for setting color and device specific stuff.
